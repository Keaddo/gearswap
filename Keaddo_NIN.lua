...
function init_gear_sets()
	...
	gear.mab_head = { name="Herculean Helm", augments={'Mag. Acc.+19 "Mag.Atk.Bns."+19','Magic burst mdg.+4%','Mag. Acc.+1',}}
	gear.mab_legs = "Herculean Trousers"
	gear.mab_feet = { name="Herculean Boots", augments={'Pet: "Dbl.Atk."+2 Pet: Crit.hit rate +2','AGI+1','Magic burst mdg.+7%','Accuracy+6 Attack+6','Mag. Acc.+20 "Mag.Atk.Bns."+20',}}
	gear.dt_head = { name="Herculean Helm", augments={'Accuracy+3 Attack+3','Phys. dmg. taken -4%','Accuracy+9','Attack+5',}}
	gear.dt_hands = { name="Herculean Gloves", augments={'AGI+8','Accuracy+9','Damage taken -3%',}}
	gear.dt_legs = "Herculean Trousers"
	gear.dt_feet = { name="Herculean Boots", augments={'STR+14','Rng.Atk.+20','Damage taken-4%',}}
	gear.ta_feet = { name="Herculean Boots", augments={'STR+9','Accuracy+20','Triple Atk.+4',}}
	gear.ta_acc_feet = { name="Herculean Boots", augments={'Accuracy+30','Triple Atk.+3',}}
    ...
    --------------------------------------
    sets.TreasureHunter = { waist="Chaac Belt", hands=th_hands, feet=th_feet }
    sets.CapacityMantle = { back="Mecistopins Mantle" }
    sets.WSDayBonus     = { head="Gavialis Helm" }
    sets.WSBack         = { back="Trepidity Mantle" }
    sets.BrutalLugra    = { ear1="Cessance Earring", ear2="Lugra Earring +1" }
    sets.BrutalTrux     = { ear1="Cessance Earring", ear2="Brutal Earring" }
    ...
    sets.precast.FC.Utsusemi = set_combine(sets.precast.FC, { neck="Magoraga Beads", body="Mochizuki Chainmail +1", ammo="Impatiens" })
    ...
    sets.midcast.ElementalNinjutsu = {
        ...
        waist="Eschan Stone",
        legs=gear.mab_legs,
        feet=gear.mab_feet -- int 10 mab+13 mac+13
    }
