...
function user_setup()
    state.OffenseMode:options('Normal', 'DD', 'Acc', 'PDT', 'MDT', 'Tanking')
...
function init_gear_sets()
    sets.enmity = {ammo="Aqreqaq Bomblet",neck="Unmoving Collar",body="Dux Scale Mail",
				back="Emico mantle",waist="Warwolf Belt",ring1="Odium ring",ring2="Provocare Ring",ear1="Friomsi Earring",legs="Obatala Subligar"}
    ...
    sets.precast.JA['Lunge'] = {head="Thaumas Hat", neck="Eddy Necklace", ear1="Novio Earring", ear2="Friomisi Earring",
            ...
            back="Evasionist's Cape", waist="Hachirin-no-obi", legs="Iuitl Tights +1", feet="Qaaxo Leggings"}
    ...
    sets.precast.JA['Vivacious Pulse'] = {head="Erilaz Galea", back="Altruistic Cape", waist="Bishop's Sash",legs="Runeist Trousers",neck="Incanter's Torque",ear1="Divine Earring",ear2="Beatific Earring"}
    ...
    sets.precast.WS['Resolution'] = {ammo="Aqreqaq Bomblet",
            ...
            body="Adhemar Jacket", hands="Herculean Gloves", ring1="Epona's Ring", ring2="Rajas Ring",
    ...
    sets.midcast['Enhancing Magic'] = {neck="Colossus's torque", ear1="Andoaa Earring", hands="Runeist mitons +1", waist="Olympus Sash", legs="Futhark Trousers"}
    ...
    sets.engaged = {ammo="Honed Tathlum",
            ...
            body="Erilaz Surcoat", hands="Herculean Gloves", ring1="Dark Ring", ring2="Defending Ring",
    ...
    sets.engaged.DD = {ammo="Ginsen",
            ...
            body="Adhemar Jacket", hands="Herculean Gloves", ring1="Epona's Ring", ring2="Rajas Ring",
            back="Atheling Mantle", waist="Windbuffet Belt", legs="Herculean Trousers", feet="Herculean Boots"}
    ...
    sets.engaged.PDT = {ammo="Aqreqaq Bomblet",
            ...
            back="Evasionist's Cape", waist="Flume Belt", legs="Erilaz leg guards +1", feet="Erilaz Greaves +1"}
    sets.engaged.MDT = {
            head="Herculean Helm", neck="Twilight Torque", ear1="Ethereal Earring", ear2="Sanare Earring",
            body="Erilaz Surcoat", hands="Herculean Gloves", ring1="Dark Ring", ring2="Defending Ring",
            back="Mubvumbamiri mantle", waist="Flume Belt", legs="Runeist Trousers", feet="Iuitl Gaiters +1"}
    sets.engaged.repulse = {back="Repulse Mantle"}
	
	sets.engaged.Tanking = {ammo="Aqreqaq Bomblet",
            head="Futhark Bandeau +1", neck="Twilight Torque", ear1="Ethereal Earring", ear2="Colossus's earring",
            body="Erilaz Surcoat", hands="Herculean Gloves", ring1="Dark Ring", ring2="Defending Ring",
            back="Evasionist's Cape", waist="Flume Belt", legs="Erilaz leg guards +1", feet="Erilaz Greaves"}
