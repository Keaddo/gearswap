...
function init_gear_sets()
	...
	sets.midcast.FastRecast = {ammo="Incantor Stone",back="Swith Cape +1"}
	...
	sets.midcast.Drain = set_combine(sets.midcast['Dark Magic'], {ammo="Incantor Stone",
		head="Pixie Hairpin +1",ear1="Hirudinea Earring",ear2="Loquacious Earring",hands="Helios Gloves",waist="Fucho-no-obi",feet=gear.merl_feet_MAB})
	...
	sets.buff['Alacrity'] = {head=gear.merl_head_MB,feet="Pedagogy Loafers +1"}
