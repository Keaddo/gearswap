function get_sets()
	...
	send_command('bind ^` gs c toggle MB set')
        ...
        sets.Idle.Standard = {ammo="Jukukik Feather",
                                                  ...
                                                  body="Assimilator's Jubbah +1",hands="Adhemar wristebands",ring1="Epona's Ring",ring2="Rajas ring",
	...
	sets.WS.VorpalBlade = {ammo="Mantoptera Eye",
        ...
        sets.Realmrazer.Attack = {ammo="Hydrocera",
                                                      head="Dampening Tam",neck="Fotia gorget",ear1="Bladeborn earring",ear2="Steelflash Earring",
                                                          ...
                                                          back="Buquwik Cape",waist="Fotia belt",legs="Telchine Braconi",feet="Herculean Boots",}
