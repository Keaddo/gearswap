function get_sets()
	...
	Cities = S{
        ...
        sets.TP.index = {'Standard', 'AccuracyLite', 'AccuracyMedium', 'AccuracyFull','DT', 'DTAccuracy'}
    ...
    back="Kayapa Cape",
        ...
        sets.TP.DTAccuracy = set_combine(sets.TP.DT,{
    ...
    back="Cornflower Cape",
        ...
        sets.WS.CircleBlade = {ammo="Mantoptera Eye",
                                                   ...
                                                   back="Buquwik Cape",waist="Prosilio Belt +1",legs="Samnuha Tights",feet={ name="Herculean Boots", augments={'Accuracy+30','Triple Atk.+3',}}}
